  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec4[0] = 1;
			iRec24[0] = (iVec4[1] + iRec24[1]) % 65536;
...
class mydsp : public base_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst27 = 0.25f * fConst0;
		fConst28 = 0.5f * fConst0;
		fConst29 = 4.0f / fConst0;
		fConst30 = 0.0f - 2.0f / fConst3;
		fConst31 = 0.3f / fConst8;
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("stray");
		ui_interface->openHorizontalBox("Modulation");
		ui_interface->declare(0, "1", "");
		ui_interface->openHorizontalBox("Modulation Frequency");
		ui_interface->declare(&fVslider6, "0", "");
		ui_interface->declare(&fVslider6, "style", "knob");
		ui_interface->addVerticalSlider("mod0", &fVslider6, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.001f));
		ui_interface->declare(&fVslider4, "1", "");
		ui_interface->declare(&fVslider4, "style", "knob");
		ui_interface->addVerticalSlider("mod1", &fVslider4, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.001f));
		ui_interface->declare(&fVslider2, "2", "");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->addVerticalSlider("mod2", &fVslider2, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.001f));
		ui_interface->declare(&fVslider0, "3", "");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("mod3", &fVslider0, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
		ui_interface->declare(0, "2", "");
		ui_interface->openHorizontalBox("Modulation Amplitude");
		ui_interface->declare(&fVslider7, "0", "");
		ui_interface->declare(&fVslider7, "style", "knob");
		ui_interface->addVerticalSlider("modA0", &fVslider7, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fVslider5, "1", "");
		ui_interface->declare(&fVslider5, "style", "knob");
		ui_interface->addVerticalSlider("modA1", &fVslider5, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fVslider3, "2", "");
		ui_interface->declare(&fVslider3, "style", "knob");
		ui_interface->addVerticalSlider("modA2", &fVslider3, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fVslider1, "3", "");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("modA3", &fVslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
		ui_interface->declare(0, "3", "");
		ui_interface->openHorizontalBox("Modulation Waveform");
		...
		ui_interface->addNumEntry("modWave0", &fEntry3, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4.0f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addNumEntry("modWave1", &fEntry2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4.0f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addNumEntry("modWave2", &fEntry1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4.0f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addNumEntry("modWave3", &fEntry0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4.0f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow27 = fConst27 / fSlow25;
		float fSlow28 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst28 / fSlow24));
		...
		float fSlow34 = fConst29 * fSlow13;
		float fSlow35 = fConst24 * float(fHslider4);
		float fSlow36 = 0.6666667f * float(fVslider1);
		...
		float fSlow57 = fConst27 / fSlow55;
		float fSlow58 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst28 / fSlow54));
		...
		float fSlow64 = fConst29 * fSlow43;
		float fSlow65 = 2.0f * float(fVslider3);
		...
		float fSlow86 = fConst27 / fSlow84;
		float fSlow87 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst28 / fSlow83));
		...
		float fSlow93 = fConst29 * fSlow72;
		float fSlow94 = 4.0f * float(fVslider5);
		...
		float fSlow101 = float(fVslider6);
		...
		float fSlow115 = fConst27 / fSlow113;
		float fSlow116 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst28 / fSlow112));
		...
		float fSlow122 = fConst29 * fSlow101;
		float fSlow123 = float(fVslider7);
		float fSlow124 = fConst31 * float(fHslider5);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp12 = fSlow22 + fRec20[1] + -1.0f;
			int iTemp13 = fTemp12 < 0.0f;
			float fTemp14 = fSlow22 + fRec20[1];
			fRec20[0] = ((iTemp13) ? fTemp14 : fTemp12);
			float fThen7 = fSlow22 + fRec20[1] + fSlow23 * fTemp12;
			float fRec21 = ((iTemp13) ? fTemp14 : fThen7);
			float fTemp15 = 2.0f * fRec21 + -1.0f;
			float fThen8 = ((iSlow11) ? fTemp11 : fThen5);
			fRec23[0] = fSlow26 + (fRec23[1] - std::floor(fSlow26 + fRec23[1]));
			float fTemp16 = mydsp_faustpower2_f(2.0f * fRec23[0] + -1.0f);
			fVec2[0] = fTemp16;
			float fTemp17 = float(iVec0[1]);
			float fTemp18 = fSlow27 * fTemp17 * (fTemp16 - fVec2[1]);
			fVec3[IOTA0 & 4095] = fTemp18;
			fRec22[0] = 0.999f * fRec22[1] + fTemp18 - (fSlow33 * fVec3[(IOTA0 - iSlow29) & 4095] + fSlow32 * fVec3[(IOTA0 - iSlow30) & 4095]);
			float fTemp19 = fSlow34 * fRec22[0];
			float fThen9 = ((iSlow10) ? fTemp15 : fThen8);
			float fTemp20 = ftbl0mydspSIG0[int(65536.0f * fRec10[0])];
			float fThen10 = ((iSlow9) ? fTemp19 : fThen9);
			fRec25[0] = fSlow35 + (fRec25[1] - std::floor(fSlow35 + fRec25[1]));
			float fTemp21 = 4.0f * fRec25[0];
			float fTemp22 = fTemp21 + -2.0f;
			float fTemp23 = fTemp21 + -1.0f;
			float fTemp24 = fTemp23 * fTemp22;
			fRec26[0] = fSlow44 + (fRec26[1] - std::floor(fSlow44 + fRec26[1]));
			float fTemp25 = 3.0f * fRec26[0];
			float fTemp26 = fTemp25 + -1.0f;
			float fTemp27 = fTemp25 + -2.0f;
			float fTemp28 = (0.0f - fTemp26) * (0.0f - 0.5f * fTemp27) + 3.0f * fRec26[0] * (0.0f - fTemp27) + 1.5f * fRec26[0] * fTemp26;
			fRec28[0] = fSlow47 * fRec29[1] + fSlow46 * fRec28[1];
			fRec29[0] = fTemp5 + fSlow46 * fRec29[1] - fSlow47 * fRec28[1];
			int iTemp29 = (fRec28[1] <= 0.0f) & (fRec28[0] > 0.0f);
			fRec27[0] = fRec27[1] * float(1 - iTemp29) + 4.656613e-10f * fTemp7 * float(iTemp29);
			float fTemp30 = fRec27[0] * fTemp28;
			float fThen12 = ((fTemp30 < -1.0f) ? -1.0f : fTemp30);
			float fTemp31 = ((fTemp30 > 1.0f) ? 1.0f : fThen12);
			float fThen13 = float(input2[i0]);
			fRec34[0] = 0.0f - fSlow50 * (fSlow49 * fRec34[1] - (fRec27[0] + fRec27[1]));
			...
			fRec30[0] = 0.0f - fSlow50 * (fSlow49 * fRec30[1] - (fRec31[0] + fRec31[1]));
			float fTemp32 = fRec30[0] * fTemp28;
			float fThen15 = ((fTemp32 < -1.0f) ? -1.0f : fTemp32);
			float fTemp33 = ((fTemp32 > 1.0f) ? 1.0f : fThen15);
			float fThen16 = ((iSlow42) ? fTemp31 : fThen13);
			float fTemp34 = fSlow52 + fRec35[1] + -1.0f;
			int iTemp35 = fTemp34 < 0.0f;
			float fTemp36 = fSlow52 + fRec35[1];
			fRec35[0] = ((iTemp35) ? fTemp36 : fTemp34);
			float fThen18 = fSlow52 + fRec35[1] + fSlow53 * fTemp34;
			float fRec36 = ((iTemp35) ? fTemp36 : fThen18);
			float fTemp37 = 2.0f * fRec36 + -1.0f;
			float fThen19 = ((iSlow41) ? fTemp33 : fThen16);
			fRec38[0] = fSlow56 + (fRec38[1] - std::floor(fSlow56 + fRec38[1]));
			float fTemp38 = mydsp_faustpower2_f(2.0f * fRec38[0] + -1.0f);
			fVec5[0] = fTemp38;
			float fTemp39 = fSlow57 * fTemp17 * (fTemp38 - fVec5[1]);
			fVec6[IOTA0 & 4095] = fTemp39;
			fRec37[0] = 0.999f * fRec37[1] + fTemp39 - (fSlow63 * fVec6[(IOTA0 - iSlow59) & 4095] + fSlow62 * fVec6[(IOTA0 - iSlow60) & 4095]);
			float fTemp40 = fSlow64 * fRec37[0];
			float fThen20 = ((iSlow40) ? fTemp37 : fThen19);
			float fTemp41 = ftbl0mydspSIG0[int(65536.0f * fRec26[0])];
			float fThen21 = ((iSlow39) ? fTemp40 : fThen20);
			float fTemp42 = fTemp21 + -3.0f;
			float fTemp43 = fTemp23 * (0.0f - fTemp42);
			fRec39[0] = fSlow73 + (fRec39[1] - std::floor(fSlow73 + fRec39[1]));
			float fTemp44 = 3.0f * fRec39[0];
			float fTemp45 = fTemp44 + -1.0f;
			float fTemp46 = fTemp44 + -2.0f;
			float fTemp47 = (0.0f - fTemp45) * (0.0f - 0.5f * fTemp46) + 3.0f * fRec39[0] * (0.0f - fTemp46) + 1.5f * fRec39[0] * fTemp45;
			fRec41[0] = fSlow76 * fRec42[1] + fSlow75 * fRec41[1];
			fRec42[0] = fTemp5 + fSlow75 * fRec42[1] - fSlow76 * fRec41[1];
			int iTemp48 = (fRec41[1] <= 0.0f) & (fRec41[0] > 0.0f);
			fRec40[0] = fRec40[1] * float(1 - iTemp48) + 4.656613e-10f * fTemp7 * float(iTemp48);
			float fTemp49 = fRec40[0] * fTemp47;
			float fThen23 = ((fTemp49 < -1.0f) ? -1.0f : fTemp49);
			float fTemp50 = ((fTemp49 > 1.0f) ? 1.0f : fThen23);
			float fThen24 = float(input1[i0]);
			fRec47[0] = 0.0f - fSlow79 * (fSlow78 * fRec47[1] - (fRec40[0] + fRec40[1]));
			fRec46[0] = 0.0f - fSlow79 * (fSlow78 * fRec46[1] - (fRec47[0] + fRec47[1]));
			fRec45[0] = 0.0f - fSlow79 * (fSlow78 * fRec45[1] - (fRec46[0] + fRec46[1]));
			fRec44[0] = 0.0f - fSlow79 * (fSlow78 * fRec44[1] - (fRec45[0] + fRec45[1]));
			fRec43[0] = 0.0f - fSlow79 * (fSlow78 * fRec43[1] - (fRec44[0] + fRec44[1]));
			float fTemp51 = fRec43[0] * fTemp47;
			float fThen26 = ((fTemp51 < -1.0f) ? -1.0f : fTemp51);
			float fTemp52 = ((fTemp51 > 1.0f) ? 1.0f : fThen26);
			float fThen27 = ((iSlow71) ? fTemp50 : fThen24);
			float fTemp53 = fSlow81 + fRec48[1] + -1.0f;
			int iTemp54 = fTemp53 < 0.0f;
			float fTemp55 = fSlow81 + fRec48[1];
			fRec48[0] = ((iTemp54) ? fTemp55 : fTemp53);
			float fThen29 = fSlow81 + fRec48[1] + fSlow82 * fTemp53;
			float fRec49 = ((iTemp54) ? fTemp55 : fThen29);
			float fTemp56 = 2.0f * fRec49 + -1.0f;
			float fThen30 = ((iSlow70) ? fTemp52 : fThen27);
			fRec51[0] = fSlow85 + (fRec51[1] - std::floor(fSlow85 + fRec51[1]));
			float fTemp57 = mydsp_faustpower2_f(2.0f * fRec51[0] + -1.0f);
			fVec7[0] = fTemp57;
			float fTemp58 = fSlow86 * fTemp17 * (fTemp57 - fVec7[1]);
			fVec8[IOTA0 & 4095] = fTemp58;
			fRec50[0] = 0.999f * fRec50[1] + fTemp58 - (fSlow92 * fVec8[(IOTA0 - iSlow88) & 4095] + fSlow91 * fVec8[(IOTA0 - iSlow89) & 4095]);
			float fTemp59 = fSlow93 * fRec50[0];
			float fThen31 = ((iSlow69) ? fTemp56 : fThen30);
			float fTemp60 = ftbl0mydspSIG0[int(65536.0f * fRec39[0])];
			float fThen32 = ((iSlow68) ? fTemp59 : fThen31);
			float fTemp61 = (0.0f - fTemp22) * (0.0f - 0.5f * fTemp42);
			fRec52[0] = fSlow102 + (fRec52[1] - std::floor(fSlow102 + fRec52[1]));
			float fTemp62 = 3.0f * fRec52[0];
			float fTemp63 = fTemp62 + -1.0f;
			float fTemp64 = fTemp62 + -2.0f;
			float fTemp65 = (0.0f - fTemp63) * (0.0f - 0.5f * fTemp64) + 3.0f * fRec52[0] * (0.0f - fTemp64) + 1.5f * fRec52[0] * fTemp63;
			fRec54[0] = fSlow105 * fRec55[1] + fSlow104 * fRec54[1];
			fRec55[0] = fTemp5 + fSlow104 * fRec55[1] - fSlow105 * fRec54[1];
			int iTemp66 = (fRec54[1] <= 0.0f) & (fRec54[0] > 0.0f);
			fRec53[0] = fRec53[1] * float(1 - iTemp66) + 4.656613e-10f * fTemp7 * float(iTemp66);
			float fTemp67 = fRec53[0] * fTemp65;
			float fThen34 = ((fTemp67 < -1.0f) ? -1.0f : fTemp67);
			float fTemp68 = ((fTemp67 > 1.0f) ? 1.0f : fThen34);
			float fThen35 = float(input0[i0]);
			fRec60[0] = 0.0f - fSlow108 * (fSlow107 * fRec60[1] - (fRec53[0] + fRec53[1]));
			fRec59[0] = 0.0f - fSlow108 * (fSlow107 * fRec59[1] - (fRec60[0] + fRec60[1]));
			fRec58[0] = 0.0f - fSlow108 * (fSlow107 * fRec58[1] - (fRec59[0] + fRec59[1]));
			fRec57[0] = 0.0f - fSlow108 * (fSlow107 * fRec57[1] - (fRec58[0] + fRec58[1]));
			fRec56[0] = 0.0f - fSlow108 * (fSlow107 * fRec56[1] - (fRec57[0] + fRec57[1]));
			float fTemp69 = fRec56[0] * fTemp65;
			float fThen37 = ((fTemp69 < -1.0f) ? -1.0f : fTemp69);
			float fTemp70 = ((fTemp69 > 1.0f) ? 1.0f : fThen37);
			float fThen38 = ((iSlow100) ? fTemp68 : fThen35);
			float fTemp71 = fSlow110 + fRec61[1] + -1.0f;
			int iTemp72 = fTemp71 < 0.0f;
			float fTemp73 = fSlow110 + fRec61[1];
			fRec61[0] = ((iTemp72) ? fTemp73 : fTemp71);
			float fThen40 = fSlow110 + fRec61[1] + fSlow111 * fTemp71;
			float fRec62 = ((iTemp72) ? fTemp73 : fThen40);
			float fTemp74 = 2.0f * fRec62 + -1.0f;
			float fThen41 = ((iSlow99) ? fTemp70 : fThen38);
			fRec64[0] = fSlow114 + (fRec64[1] - std::floor(fSlow114 + fRec64[1]));
			float fTemp75 = mydsp_faustpower2_f(2.0f * fRec64[0] + -1.0f);
			fVec9[0] = fTemp75;
			float fTemp76 = fSlow115 * fTemp17 * (fTemp75 - fVec9[1]);
			fVec10[IOTA0 & 4095] = fTemp76;
			fRec63[0] = 0.999f * fRec63[1] + fTemp76 - (fSlow121 * fVec10[(IOTA0 - iSlow117) & 4095] + fSlow120 * fVec10[(IOTA0 - iSlow118) & 4095]);
			float fTemp77 = fSlow122 * fRec63[0];
			float fThen42 = ((iSlow98) ? fTemp74 : fThen41);
			float fTemp78 = ftbl0mydspSIG0[int(65536.0f * fRec52[0])];
			float fThen43 = ((iSlow97) ? fTemp77 : fThen42);
			float fTemp79 = (0.0f - fTemp23) * (0.0f - 0.5f * fTemp22) * (0.0f - 0.33333334f * fTemp42);
			float fThen44 = float(input7[i0]);
			float fThen45 = ((iSlow12) ? fTemp9 : fThen44);
			float fThen46 = ((iSlow11) ? fTemp11 : fThen45);
			float fThen47 = ((iSlow10) ? fTemp15 : fThen46);
			float fThen48 = ((iSlow9) ? fTemp19 : fThen47);
			float fThen49 = float(input6[i0]);
			float fThen50 = ((iSlow42) ? fTemp31 : fThen49);
			float fThen51 = ((iSlow41) ? fTemp33 : fThen50);
			float fThen52 = ((iSlow40) ? fTemp37 : fThen51);
			float fThen53 = ((iSlow39) ? fTemp40 : fThen52);
			float fThen54 = float(input5[i0]);
			float fThen55 = ((iSlow71) ? fTemp50 : fThen54);
			float fThen56 = ((iSlow70) ? fTemp52 : fThen55);
			float fThen57 = ((iSlow69) ? fTemp56 : fThen56);
			...
			float fThen62 = ((iSlow98) ? fTemp74 : fThen61);
			float fThen63 = ((iSlow97) ? fTemp77 : fThen62);
			float fThen64 = float(input11[i0]);
			float fThen65 = ((iSlow12) ? fTemp9 : fThen64);
			float fThen66 = ((iSlow11) ? fTemp11 : fThen65);
			float fThen67 = ((iSlow10) ? fTemp15 : fThen66);
			float fThen68 = ((iSlow9) ? fTemp19 : fThen67);
			float fThen69 = float(input10[i0]);
			float fThen70 = ((iSlow42) ? fTemp31 : fThen69);
			float fThen71 = ((iSlow41) ? fTemp33 : fThen70);
			float fThen72 = ((iSlow40) ? fTemp37 : fThen71);
			float fThen73 = ((iSlow39) ? fTemp40 : fThen72);
			float fThen74 = float(input9[i0]);
			float fThen75 = ((iSlow71) ? fTemp50 : fThen74);
			float fThen76 = ((iSlow70) ? fTemp52 : fThen75);
			float fThen77 = ((iSlow69) ? fTemp56 : fThen76);
			...
			float fThen82 = ((iSlow98) ? fTemp74 : fThen81);
			float fThen83 = ((iSlow97) ? fTemp77 : fThen82);
			float fThen84 = fSlow123 * fTemp79 * ((iSlow96) ? fTemp78 : fThen83) + fRec25[0] * (fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen78) + fSlow65 * fTemp43 * ((iSlow38) ? fTemp41 : fThen73) + fSlow36 * fTemp24 * ((iSlow8) ? fTemp20 : fThen68));
			float fThen85 = (((fSlow123 * fTemp79 * ((iSlow96) ? fTemp78 : fThen63) + fRec25[0] * (fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen58) + fSlow65 * fTemp43 * ((iSlow38) ? fTemp41 : fThen53) + fSlow36 * fTemp24 * ((iSlow8) ? fTemp20 : fThen48))) < -1.0f) ? -1.0f : fThen84);
			fRec9[0] = (((fSlow123 * fTemp79 * ((iSlow96) ? fTemp78 : fThen43) + fRec25[0] * (fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen32) + fSlow65 * fTemp43 * ((iSlow38) ? fTemp41 : fThen21) + fSlow36 * fTemp24 * ((iSlow8) ? fTemp20 : fThen10))) > 1.0f) ? 1.0f : fThen85) - fConst23 * (fConst22 * fRec9[2] + fConst5 * fRec9[1]);
			fRec8[0] = fConst23 * (fConst4 * fRec9[0] + fConst30 * fRec9[1] + fConst4 * fRec9[2]) - fConst21 * (fConst20 * fRec8[2] + fConst5 * fRec8[1]);
			fRec7[0] = fConst21 * (fConst4 * fRec8[0] + fConst30 * fRec8[1] + fConst4 * fRec8[2]) - fConst19 * (fConst18 * fRec7[2] + fConst5 * fRec7[1]);
			fRec6[0] = fConst19 * (fConst4 * fRec7[0] + fConst30 * fRec7[1] + fConst4 * fRec7[2]) - fConst17 * (fConst16 * fRec6[2] + fConst5 * fRec6[1]);
			fRec5[0] = fConst17 * (fConst4 * fRec6[0] + fConst30 * fRec6[1] + fConst4 * fRec6[2]) - fConst15 * (fConst14 * fRec5[2] + fConst5 * fRec5[1]);
			fRec4[0] = fConst15 * (fConst4 * fRec5[0] + fConst30 * fRec5[1] + fConst4 * fRec5[2]) - fConst13 * (fConst12 * fRec4[2] + fConst5 * fRec4[1]);
			fRec3[0] = fConst13 * (fConst4 * fRec4[0] + fConst30 * fRec4[1] + fConst4 * fRec4[2]) - fConst11 * (fConst10 * fRec3[2] + fConst5 * fRec3[1]);
			fRec2[0] = fConst11 * (fConst4 * fRec3[0] + fConst30 * fRec3[1] + fConst4 * fRec3[2]) - fConst9 * (fConst7 * fRec2[2] + fConst5 * fRec2[1]);
			output0[i0] = FAUSTFLOAT(fSlow124 * (fConst4 * fRec2[0] + fConst30 * fRec2[1] + fConst4 * fRec2[2]) * fTemp0);
			float fThen86 = float(input15[i0]);
			float fThen87 = ((iSlow12) ? fTemp9 : fThen86);
			float fThen88 = ((iSlow11) ? fTemp11 : fThen87);
			float fThen89 = ((iSlow10) ? fTemp15 : fThen88);
			float fThen90 = ((iSlow9) ? fTemp19 : fThen89);
			float fThen91 = float(input14[i0]);
			float fThen92 = ((iSlow42) ? fTemp31 : fThen91);
			float fThen93 = ((iSlow41) ? fTemp33 : fThen92);
			float fThen94 = ((iSlow40) ? fTemp37 : fThen93);
			float fThen95 = ((iSlow39) ? fTemp40 : fThen94);
			float fThen96 = float(input13[i0]);
			float fThen97 = ((iSlow71) ? fTemp50 : fThen96);
			float fThen98 = ((iSlow70) ? fTemp52 : fThen97);
			float fThen99 = ((iSlow69) ? fTemp56 : fThen98);
			...
			float fThen104 = ((iSlow98) ? fTemp74 : fThen103);
			float fThen105 = ((iSlow97) ? fTemp77 : fThen104);
			float fThen106 = float(input19[i0]);
			float fThen107 = ((iSlow12) ? fTemp9 : fThen106);
			float fThen108 = ((iSlow11) ? fTemp11 : fThen107);
			float fThen109 = ((iSlow10) ? fTemp15 : fThen108);
			float fThen110 = ((iSlow9) ? fTemp19 : fThen109);
			float fThen111 = float(input18[i0]);
			float fThen112 = ((iSlow42) ? fTemp31 : fThen111);
			float fThen113 = ((iSlow41) ? fTemp33 : fThen112);
			float fThen114 = ((iSlow40) ? fTemp37 : fThen113);
			float fThen115 = ((iSlow39) ? fTemp40 : fThen114);
			float fThen116 = float(input17[i0]);
			float fThen117 = ((iSlow71) ? fTemp50 : fThen116);
			float fThen118 = ((iSlow70) ? fTemp52 : fThen117);
			float fThen119 = ((iSlow69) ? fTemp56 : fThen118);
			...
			float fThen124 = ((iSlow98) ? fTemp74 : fThen123);
			float fThen125 = ((iSlow97) ? fTemp77 : fThen124);
			float fThen126 = float(input23[i0]);
			float fThen127 = ((iSlow12) ? fTemp9 : fThen126);
			float fThen128 = ((iSlow11) ? fTemp11 : fThen127);
			float fThen129 = ((iSlow10) ? fTemp15 : fThen128);
			float fThen130 = ((iSlow9) ? fTemp19 : fThen129);
			float fThen131 = float(input22[i0]);
			float fThen132 = ((iSlow42) ? fTemp31 : fThen131);
			float fThen133 = ((iSlow41) ? fTemp33 : fThen132);
			float fThen134 = ((iSlow40) ? fTemp37 : fThen133);
			float fThen135 = ((iSlow39) ? fTemp40 : fThen134);
			float fThen136 = float(input21[i0]);
			float fThen137 = ((iSlow71) ? fTemp50 : fThen136);
			float fThen138 = ((iSlow70) ? fTemp52 : fThen137);
			float fThen139 = ((iSlow69) ? fTemp56 : fThen138);
			...
			float fThen144 = ((iSlow98) ? fTemp74 : fThen143);
			float fThen145 = ((iSlow97) ? fTemp77 : fThen144);
			float fThen146 = fSlow123 * fTemp79 * ((iSlow96) ? fTemp78 : fThen145) + fRec25[0] * (fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen140) + fSlow65 * fTemp43 * ((iSlow38) ? fTemp41 : fThen135) + fSlow36 * fTemp24 * ((iSlow8) ? fTemp20 : fThen130));
			float fThen147 = (((fSlow123 * fTemp79 * ((iSlow96) ? fTemp78 : fThen125) + fRec25[0] * (fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen120) + fSlow65 * fTemp43 * ((iSlow38) ? fTemp41 : fThen115) + fSlow36 * fTemp24 * ((iSlow8) ? fTemp20 : fThen110))) < -1.0f) ? -1.0f : fThen146);
			fRec72[0] = (((fSlow123 * fTemp79 * ((iSlow96) ? fTemp78 : fThen105) + fRec25[0] * (fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen100) + fSlow65 * fTemp43 * ((iSlow38) ? fTemp41 : fThen95) + fSlow36 * fTemp24 * ((iSlow8) ? fTemp20 : fThen90))) > 1.0f) ? 1.0f : fThen147) - fConst23 * (fConst22 * fRec72[2] + fConst5 * fRec72[1]);
			fRec71[0] = fConst23 * (fConst4 * fRec72[0] + fConst30 * fRec72[1] + fConst4 * fRec72[2]) - fConst21 * (fConst20 * fRec71[2] + fConst5 * fRec71[1]);
			fRec70[0] = fConst21 * (fConst4 * fRec71[0] + fConst30 * fRec71[1] + fConst4 * fRec71[2]) - fConst19 * (fConst18 * fRec70[2] + fConst5 * fRec70[1]);
			fRec69[0] = fConst19 * (fConst4 * fRec70[0] + fConst30 * fRec70[1] + fConst4 * fRec70[2]) - fConst17 * (fConst16 * fRec69[2] + fConst5 * fRec69[1]);
			fRec68[0] = fConst17 * (fConst4 * fRec69[0] + fConst30 * fRec69[1] + fConst4 * fRec69[2]) - fConst15 * (fConst14 * fRec68[2] + fConst5 * fRec68[1]);
			fRec67[0] = fConst15 * (fConst4 * fRec68[0] + fConst30 * fRec68[1] + fConst4 * fRec68[2]) - fConst13 * (fConst12 * fRec67[2] + fConst5 * fRec67[1]);
			fRec66[0] = fConst13 * (fConst4 * fRec67[0] + fConst30 * fRec67[1] + fConst4 * fRec67[2]) - fConst11 * (fConst10 * fRec66[2] + fConst5 * fRec66[1]);
			fRec65[0] = fConst11 * (fConst4 * fRec66[0] + fConst30 * fRec66[1] + fConst4 * fRec66[2]) - fConst9 * (fConst7 * fRec65[2] + fConst5 * fRec65[1]);
			output1[i0] = FAUSTFLOAT(fSlow124 * fTemp0 * (fConst4 * fRec65[0] + fConst30 * fRec65[1] + fConst4 * fRec65[2]));
			iVec0[1] = iVec0[0];
			fVec1[1] = fVec1[0];
			iRec0[1] = iRec0[0];
			fRec1[1] = fRec1[0];
	...
	#define FAUST_FILE_NAME "stray.dsp"
	...
	FAUST_ADDVERTICALSLIDER("Modulation/[1]Modulation Frequency/mod0", fVslider6, 0.001f, 0.001f, 2e+01f, 0.001f);
	FAUST_ADDVERTICALSLIDER("Modulation/[1]Modulation Frequency/mod1", fVslider4, 0.001f, 0.001f, 2e+01f, 0.001f);
	FAUST_ADDVERTICALSLIDER("Modulation/[1]Modulation Frequency/mod2", fVslider2, 0.001f, 0.001f, 2e+01f, 0.001f);
	FAUST_ADDVERTICALSLIDER("Modulation/[1]Modulation Frequency/mod3", fVslider0, 0.001f, 0.001f, 2e+01f, 0.001f);
	FAUST_ADDVERTICALSLIDER("Modulation/[2]Modulation Amplitude/modA0", fVslider7, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("Modulation/[2]Modulation Amplitude/modA1", fVslider5, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("Modulation/[2]Modulation Amplitude/modA2", fVslider3, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDVERTICALSLIDER("Modulation/[2]Modulation Amplitude/modA3", fVslider1, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDNUMENTRY("Modulation/[3]Modulation Waveform/modWave0", fEntry3, 0.0f, 0.0f, 4.0f, 1.0f);
	FAUST_ADDNUMENTRY("Modulation/[3]Modulation Waveform/modWave1", fEntry2, 0.0f, 0.0f, 4.0f, 1.0f);
	FAUST_ADDNUMENTRY("Modulation/[3]Modulation Waveform/modWave2", fEntry1, 0.0f, 0.0f, 4.0f, 1.0f);
	FAUST_ADDNUMENTRY("Modulation/[3]Modulation Waveform/modWave3", fEntry0, 0.0f, 0.0f, 4.0f, 1.0f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, mod0, "Modulation/[1]Modulation Frequency/mod0", fVslider6, 0.001f, 0.001f, 2e+01f, 0.001f) \
		p(VERTICALSLIDER, mod1, "Modulation/[1]Modulation Frequency/mod1", fVslider4, 0.001f, 0.001f, 2e+01f, 0.001f) \
		p(VERTICALSLIDER, mod2, "Modulation/[1]Modulation Frequency/mod2", fVslider2, 0.001f, 0.001f, 2e+01f, 0.001f) \
		p(VERTICALSLIDER, mod3, "Modulation/[1]Modulation Frequency/mod3", fVslider0, 0.001f, 0.001f, 2e+01f, 0.001f) \
		p(VERTICALSLIDER, modA0, "Modulation/[2]Modulation Amplitude/modA0", fVslider7, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(VERTICALSLIDER, modA1, "Modulation/[2]Modulation Amplitude/modA1", fVslider5, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(VERTICALSLIDER, modA2, "Modulation/[2]Modulation Amplitude/modA2", fVslider3, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(VERTICALSLIDER, modA3, "Modulation/[2]Modulation Amplitude/modA3", fVslider1, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(NUMENTRY, modWave0, "Modulation/[3]Modulation Waveform/modWave0", fEntry3, 0.0f, 0.0f, 4.0f, 1.0f) \
		p(NUMENTRY, modWave1, "Modulation/[3]Modulation Waveform/modWave1", fEntry2, 0.0f, 0.0f, 4.0f, 1.0f) \
		p(NUMENTRY, modWave2, "Modulation/[3]Modulation Waveform/modWave2", fEntry1, 0.0f, 0.0f, 4.0f, 1.0f) \
		p(NUMENTRY, modWave3, "Modulation/[3]Modulation Waveform/modWave3", fEntry0, 0.0f, 0.0f, 4.0f, 1.0f) \
