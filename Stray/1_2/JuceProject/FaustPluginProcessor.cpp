...
class uiBox : public uiBase, public juce::Component
{
    ...
    public:
        ...
        void paint(juce::Graphics& g) override
        {
            ...
            g.setColour(juce::Colours::darkslategrey.withAlpha(0.75f));
  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec4[0] = 1;
			iRec25[0] = (iVec4[1] + iRec25[1]) % 65536;
			table[i1] = std::sin(9.58738e-05f * float(iRec25[0]));
			iVec4[1] = iVec4[0];
			iRec25[1] = iRec25[0];
		}
	}
...
class mydsp : public base_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "stray_1_2.dsp");
		...
		m->declare("interpolators_lib_lagrangeInterpolation_author", "Dario Sanfilippo");
		m->declare("interpolators_lib_lagrangeInterpolation_copyright", "Copyright (C) 2021 Dario Sanfilippo     <sanfilippo.dario@gmail.com>");
		m->declare("interpolators_lib_lagrangeInterpolation_license", "MIT license");
		...
		m->declare("library_path5", "/libraries/noises.lib");
		m->declare("library_path6", "/libraries/filters.lib");
		m->declare("library_path7", "/libraries/interpolators.lib");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst2 = std::tan(47.12389f / fConst0);
		float fConst3 = mydsp_faustpower2_f(fConst2);
		fConst4 = 1.0f / fConst3;
		fConst5 = 2.0f * (1.0f - fConst4);
		float fConst6 = 1.0f / fConst2;
		fConst7 = (fConst6 + -0.19603428f) / fConst2 + 1.0f;
		float fConst8 = (fConst6 + 0.19603428f) / fConst2 + 1.0f;
		fConst9 = 1.0f / fConst8;
		fConst10 = (fConst6 + -0.5805693f) / fConst2 + 1.0f;
		fConst11 = 1.0f / ((fConst6 + 0.5805693f) / fConst2 + 1.0f);
		fConst12 = (fConst6 + -0.9427935f) / fConst2 + 1.0f;
		fConst13 = 1.0f / ((fConst6 + 0.9427935f) / fConst2 + 1.0f);
		fConst14 = (fConst6 + -1.2687865f) / fConst2 + 1.0f;
		fConst15 = 1.0f / ((fConst6 + 1.2687865f) / fConst2 + 1.0f);
		fConst16 = (fConst6 + -1.5460209f) / fConst2 + 1.0f;
		fConst17 = 1.0f / ((fConst6 + 1.5460209f) / fConst2 + 1.0f);
		fConst18 = (fConst6 + -1.7638426f) / fConst2 + 1.0f;
		fConst19 = 1.0f / ((fConst6 + 1.7638426f) / fConst2 + 1.0f);
		fConst20 = (fConst6 + -1.9138807f) / fConst2 + 1.0f;
		fConst21 = 1.0f / ((fConst6 + 1.9138807f) / fConst2 + 1.0f);
		fConst22 = (fConst6 + -1.9903694f) / fConst2 + 1.0f;
		fConst23 = 1.0f / ((fConst6 + 1.9903694f) / fConst2 + 1.0f);
		fConst24 = 1.0f / fConst0;
		fConst25 = 6.2831855f / fConst0;
		fConst26 = 3.1415927f / fConst0;
		fConst27 = 44.1f / fConst0;
		fConst28 = 1.0f - fConst27;
		fConst29 = 0.25f * fConst0;
		fConst30 = 0.5f * fConst0;
		fConst31 = 4.0f / fConst0;
		fConst32 = 0.0f - 2.0f / fConst3;
		fConst33 = 0.3f / fConst8;
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("stray_1_2");
		ui_interface->openHorizontalBox("Wave Point Control");
		ui_interface->declare(0, "0", "");
		ui_interface->openHorizontalBox("Point Oscillation Frequency");
		ui_interface->declare(&fVslider3, "0", "");
		ui_interface->declare(&fVslider3, "tooltip", "Frequency of the LFO controlling Point 0 of the Waveform");
		ui_interface->declare(&fVslider3, "unit", "Hz");
		ui_interface->addVerticalSlider("P0 Freq", &fVslider3, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.001f));
		ui_interface->declare(&fVslider2, "1", "");
		ui_interface->declare(&fVslider2, "tooltip", "Frequency of the LFO controlling Point 1 of the Waveform");
		ui_interface->declare(&fVslider2, "unit", "Hz");
		ui_interface->addVerticalSlider("P1 Freq", &fVslider2, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.001f));
		ui_interface->declare(&fVslider1, "2", "");
		ui_interface->declare(&fVslider1, "tooltip", "Frequency of the LFO controlling Point 2 of the Waveform");
		ui_interface->declare(&fVslider1, "unit", "Hz");
		ui_interface->addVerticalSlider("P2 Freq", &fVslider1, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.001f));
		ui_interface->declare(&fVslider0, "3", "");
		ui_interface->declare(&fVslider0, "tooltip", "Frequency of the LFO controlling Point 3 of the Waveform");
		ui_interface->declare(&fVslider0, "unit", "Hz");
		ui_interface->addVerticalSlider("P3 Freq", &fVslider0, FAUSTFLOAT(0.001f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openVerticalBox("Point LFO");
		ui_interface->declare(0, "2", "");
		ui_interface->openHorizontalBox("On | Off");
		ui_interface->declare(&fCheckbox3, "0", "");
		ui_interface->declare(&fCheckbox3, "tooltip", "Turn On/Off LFO for Point 0");
		ui_interface->addCheckButton("P0 Toggle", &fCheckbox3);
		ui_interface->declare(&fCheckbox2, "1", "");
		ui_interface->declare(&fCheckbox2, "tooltip", "Turn On/Off LFO for Point 1");
		ui_interface->addCheckButton("P1 Toggle", &fCheckbox2);
		ui_interface->declare(&fCheckbox1, "2", "");
		ui_interface->declare(&fCheckbox1, "tooltip", "Turn On/Off LFO for Point 2");
		ui_interface->addCheckButton("P2 Toggle", &fCheckbox1);
		ui_interface->declare(&fCheckbox0, "3", "");
		ui_interface->declare(&fCheckbox0, "tooltip", "Turn On/Off LFO for Point 3");
		ui_interface->addCheckButton("P3 Toggle", &fCheckbox0);
		ui_interface->closeBox();
		ui_interface->declare(0, "3", "");
		ui_interface->openHorizontalBox("LFO Shape: 0 = sin, 1 = tri, 2 = saw, 3 = smooth rand, 4 = coarse rand");
		ui_interface->declare(&fEntry3, "0", "");
		ui_interface->declare(&fEntry3, "style", "menu{'Sine':0;'Triangle':1;'Sawtooth':2'Smooth Rand':3;'Coarse Rand':4}");
		ui_interface->declare(&fEntry3, "tooltip", "Change the LFO Shape for Point 0");
		ui_interface->addNumEntry("P0 Shape", &fEntry3, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fEntry2, "1", "");
		ui_interface->declare(&fEntry2, "style", "menu{'Sine':0;'Triangle':1;'Sawtooth':2'Smooth Rand':3;'Coarse Rand':4}");
		ui_interface->declare(&fEntry2, "tooltip", "Change the LFO Shape for Point 1");
		ui_interface->addNumEntry("P1 Shape", &fEntry2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fEntry1, "2", "");
		ui_interface->declare(&fEntry1, "style", "menu{'Sine':0;'Triangle':1;'Sawtooth':2'Smooth Rand':3;'Coarse Rand':4}");
		ui_interface->declare(&fEntry1, "tooltip", "Change the LFO Shape for Point 2");
		ui_interface->addNumEntry("P2 Shape", &fEntry1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fEntry0, "3", "");
		ui_interface->declare(&fEntry0, "style", "menu{'Sine':0;'Triangle':1;'Sawtooth':2'Smooth Rand':3;'Coarse Rand':4}");
		ui_interface->declare(&fEntry0, "tooltip", "Change the LFO Shape for Point 3");
		ui_interface->addNumEntry("P3 Shape", &fEntry0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4.0f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->declare(0, "0", "");
		...
		ui_interface->addHorizontalSlider("Attack", &fHslider1, FAUSTFLOAT(5e+01f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fHslider2, "1", "");
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->declare(&fHslider2, "unit", "ms");
		ui_interface->addHorizontalSlider("Decay", &fHslider2, FAUSTFLOAT(5e+01f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fHslider3, "2", "");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->declare(&fHslider3, "unit", "A");
		ui_interface->addHorizontalSlider("Sustain", &fHslider3, FAUSTFLOAT(0.8f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider0, "3", "");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->declare(&fHslider0, "unit", "ms");
		ui_interface->addHorizontalSlider("Release", &fHslider0, FAUSTFLOAT(5e+01f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("freq", &fHslider4, FAUSTFLOAT(3e+02f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(3e+03f), FAUSTFLOAT(0.1f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		int iSlow11 = fSlow7 == 3.0f;
		int iSlow12 = fSlow7 == 4.0f;
		float fSlow13 = float(fVslider0);
		float fSlow14 = fConst24 * fSlow13;
		float fSlow15 = fConst25 * fSlow13;
		float fSlow16 = std::cos(fSlow15);
		float fSlow17 = std::sin(fSlow15);
		float fSlow18 = 1.0f / std::tan(fConst26 * fSlow13);
		float fSlow19 = 1.0f - fSlow18;
		float fSlow20 = 1.0f / (fSlow18 + 1.0f);
		float fSlow21 = std::max<float>(1.1920929e-07f, std::fabs(fSlow13));
		float fSlow22 = fConst24 * fSlow21;
		float fSlow23 = 1.0f - fConst0 / fSlow21;
		float fSlow24 = std::max<float>(fSlow13, 23.44895f);
		float fSlow25 = std::max<float>(2e+01f, std::fabs(fSlow24));
		float fSlow26 = fConst24 * fSlow25;
		float fSlow27 = fConst29 / fSlow25;
		float fSlow28 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst30 / fSlow24));
		int iSlow29 = int(fSlow28);
		int iSlow30 = iSlow29 + 1;
		float fSlow31 = std::floor(fSlow28);
		float fSlow32 = fSlow28 - fSlow31;
		float fSlow33 = fSlow31 + (1.0f - fSlow28);
		float fSlow34 = fConst31 * fSlow13;
		float fSlow35 = fConst24 * float(fHslider4);
		float fSlow36 = 0.25f * float(fCheckbox0);
		float fSlow37 = float(fEntry1);
		int iSlow38 = fSlow37 == 0.0f;
		int iSlow39 = fSlow37 == 1.0f;
		int iSlow40 = fSlow37 == 2.0f;
		int iSlow41 = fSlow37 == 3.0f;
		int iSlow42 = fSlow37 == 4.0f;
		float fSlow43 = float(fVslider1);
		float fSlow44 = fConst24 * fSlow43;
		float fSlow45 = fConst25 * fSlow43;
		float fSlow46 = std::cos(fSlow45);
		float fSlow47 = std::sin(fSlow45);
		float fSlow48 = 1.0f / std::tan(fConst26 * fSlow43);
		float fSlow49 = 1.0f - fSlow48;
		float fSlow50 = 1.0f / (fSlow48 + 1.0f);
		float fSlow51 = std::max<float>(1.1920929e-07f, std::fabs(fSlow43));
		float fSlow52 = fConst24 * fSlow51;
		float fSlow53 = 1.0f - fConst0 / fSlow51;
		float fSlow54 = std::max<float>(fSlow43, 23.44895f);
		float fSlow55 = std::max<float>(2e+01f, std::fabs(fSlow54));
		float fSlow56 = fConst24 * fSlow55;
		float fSlow57 = fConst29 / fSlow55;
		float fSlow58 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst30 / fSlow54));
		int iSlow59 = int(fSlow58);
		int iSlow60 = iSlow59 + 1;
		float fSlow61 = std::floor(fSlow58);
		float fSlow62 = fSlow58 - fSlow61;
		float fSlow63 = fSlow61 + (1.0f - fSlow58);
		float fSlow64 = fConst31 * fSlow43;
		float fSlow65 = float(fCheckbox1);
		float fSlow66 = float(fEntry2);
		int iSlow67 = fSlow66 == 0.0f;
		int iSlow68 = fSlow66 == 1.0f;
		int iSlow69 = fSlow66 == 2.0f;
		int iSlow70 = fSlow66 == 3.0f;
		int iSlow71 = fSlow66 == 4.0f;
		float fSlow72 = float(fVslider2);
		float fSlow73 = fConst24 * fSlow72;
		float fSlow74 = fConst25 * fSlow72;
		float fSlow75 = std::cos(fSlow74);
		float fSlow76 = std::sin(fSlow74);
		float fSlow77 = 1.0f / std::tan(fConst26 * fSlow72);
		float fSlow78 = 1.0f - fSlow77;
		float fSlow79 = 1.0f / (fSlow77 + 1.0f);
		float fSlow80 = std::max<float>(1.1920929e-07f, std::fabs(fSlow72));
		float fSlow81 = fConst24 * fSlow80;
		float fSlow82 = 1.0f - fConst0 / fSlow80;
		float fSlow83 = std::max<float>(fSlow72, 23.44895f);
		float fSlow84 = std::max<float>(2e+01f, std::fabs(fSlow83));
		float fSlow85 = fConst24 * fSlow84;
		float fSlow86 = fConst29 / fSlow84;
		float fSlow87 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst30 / fSlow83));
		int iSlow88 = int(fSlow87);
		int iSlow89 = iSlow88 + 1;
		float fSlow90 = std::floor(fSlow87);
		float fSlow91 = fSlow87 - fSlow90;
		float fSlow92 = fSlow90 + (1.0f - fSlow87);
		float fSlow93 = fConst31 * fSlow72;
		float fSlow94 = 3.0f * float(fCheckbox2);
		float fSlow95 = float(fEntry3);
		int iSlow96 = fSlow95 == 0.0f;
		int iSlow97 = fSlow95 == 1.0f;
		int iSlow98 = fSlow95 == 2.0f;
		int iSlow99 = fSlow95 == 3.0f;
		int iSlow100 = fSlow95 == 4.0f;
		float fSlow101 = float(fVslider3);
		float fSlow102 = fConst24 * fSlow101;
		float fSlow103 = fConst25 * fSlow101;
		float fSlow104 = std::cos(fSlow103);
		float fSlow105 = std::sin(fSlow103);
		float fSlow106 = 1.0f / std::tan(fConst26 * fSlow101);
		float fSlow107 = 1.0f - fSlow106;
		float fSlow108 = 1.0f / (fSlow106 + 1.0f);
		float fSlow109 = std::max<float>(1.1920929e-07f, std::fabs(fSlow101));
		float fSlow110 = fConst24 * fSlow109;
		float fSlow111 = 1.0f - fConst0 / fSlow109;
		float fSlow112 = std::max<float>(fSlow101, 23.44895f);
		float fSlow113 = std::max<float>(2e+01f, std::fabs(fSlow112));
		float fSlow114 = fConst24 * fSlow113;
		float fSlow115 = fConst29 / fSlow113;
		float fSlow116 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst30 / fSlow112));
		int iSlow117 = int(fSlow116);
		int iSlow118 = iSlow117 + 1;
		float fSlow119 = std::floor(fSlow116);
		float fSlow120 = fSlow116 - fSlow119;
		float fSlow121 = fSlow119 + (1.0f - fSlow116);
		float fSlow122 = fConst31 * fSlow101;
		float fSlow123 = 6.0f * float(fCheckbox3);
		float fSlow124 = fConst33 * float(fHslider5);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			fVec1[0] = fSlow0;
			iRec0[0] = iSlow1 * (iRec0[1] + 1);
			fRec1[0] = fSlow0 + fRec1[1] * float(fVec1[1] >= fSlow0);
			float fTemp0 = std::max<float>(0.0f, std::min<float>(fSlow4 * fRec1[0], std::max<float>(fSlow6 * (fSlow3 - fRec1[0]) + 1.0f, fSlow5)) * (1.0f - fSlow2 * float(iRec0[0])));
			fRec10[0] = fSlow14 + (fRec10[1] - std::floor(fSlow14 + fRec10[1]));
			float fTemp1 = 3.0f * fRec10[0];
			float fTemp2 = fTemp1 + -1.0f;
			float fTemp3 = fTemp1 + -2.0f;
			float fTemp4 = (0.0f - fTemp2) * (0.0f - 0.5f * fTemp3) + 3.0f * fRec10[0] * (0.0f - fTemp3) + 1.5f * fRec10[0] * fTemp2;
			fRec12[0] = fSlow17 * fRec13[1] + fSlow16 * fRec12[1];
			float fTemp5 = float(1 - iVec0[1]);
			fRec13[0] = fTemp5 + fSlow16 * fRec13[1] - fSlow17 * fRec12[1];
			int iTemp6 = (fRec12[1] <= 0.0f) & (fRec12[0] > 0.0f);
			iRec14[0] = 1103515245 * iRec14[1] + 12345;
			float fTemp7 = float(iRec14[0]);
			fRec11[0] = fRec11[1] * float(1 - iTemp6) + 4.656613e-10f * fTemp7 * float(iTemp6);
			float fTemp8 = fRec11[0] * fTemp4;
			float fThen1 = ((fTemp8 < -1.0f) ? -1.0f : fTemp8);
			float fTemp9 = ((fTemp8 > 1.0f) ? 1.0f : fThen1);
			float fThen2 = float(input3[i0]);
			fRec19[0] = 0.0f - fSlow20 * (fSlow19 * fRec19[1] - (fRec11[0] + fRec11[1]));
			fRec18[0] = 0.0f - fSlow20 * (fSlow19 * fRec18[1] - (fRec19[0] + fRec19[1]));
			fRec17[0] = 0.0f - fSlow20 * (fSlow19 * fRec17[1] - (fRec18[0] + fRec18[1]));
			fRec16[0] = 0.0f - fSlow20 * (fSlow19 * fRec16[1] - (fRec17[0] + fRec17[1]));
			fRec15[0] = 0.0f - fSlow20 * (fSlow19 * fRec15[1] - (fRec16[0] + fRec16[1]));
			float fTemp10 = fRec15[0] * fTemp4;
			float fThen4 = ((fTemp10 < -1.0f) ? -1.0f : fTemp10);
			float fTemp11 = ((fTemp10 > 1.0f) ? 1.0f : fThen4);
			float fThen5 = ((iSlow12) ? fTemp9 : fThen2);
			float fTemp12 = fSlow22 + fRec21[1] + -1.0f;
			int iTemp13 = fTemp12 < 0.0f;
			float fTemp14 = fSlow22 + fRec21[1];
			fRec21[0] = ((iTemp13) ? fTemp14 : fTemp12);
			float fThen7 = fSlow22 + fRec21[1] + fSlow23 * fTemp12;
			float fRec22 = ((iTemp13) ? fTemp14 : fThen7);
			fRec20[0] = fConst27 * (2.0f * fRec22 + -1.0f) + fConst28 * fRec20[1];
			float fThen8 = ((iSlow11) ? fTemp11 : fThen5);
			fRec24[0] = fSlow26 + (fRec24[1] - std::floor(fSlow26 + fRec24[1]));
			float fTemp15 = mydsp_faustpower2_f(2.0f * fRec24[0] + -1.0f);
			fVec2[0] = fTemp15;
			float fTemp16 = float(iVec0[1]);
			float fTemp17 = fSlow27 * fTemp16 * (fTemp15 - fVec2[1]);
			fVec3[IOTA0 & 4095] = fTemp17;
			fRec23[0] = 0.999f * fRec23[1] + fTemp17 - (fSlow33 * fVec3[(IOTA0 - iSlow29) & 4095] + fSlow32 * fVec3[(IOTA0 - iSlow30) & 4095]);
			float fTemp18 = fSlow34 * fRec23[0];
			float fThen9 = ((iSlow10) ? fRec20[0] : fThen8);
			float fTemp19 = ftbl0mydspSIG0[int(65536.0f * fRec10[0])];
			float fThen10 = ((iSlow9) ? fTemp18 : fThen9);
			fRec26[0] = fSlow35 + (fRec26[1] - std::floor(fSlow35 + fRec26[1]));
			float fTemp20 = 6.0f * fRec26[0];
			float fTemp21 = fTemp20 + -5.0f;
			float fTemp22 = fTemp20 + -3.0f;
			float fTemp23 = fTemp20 + -2.0f;
			float fTemp24 = fTemp20 + -1.0f;
			float fTemp25 = fTemp24 * fTemp23;
			float fTemp26 = fTemp25 * fTemp22 * (0.0f - fTemp21);
			fRec27[0] = fSlow44 + (fRec27[1] - std::floor(fSlow44 + fRec27[1]));
			float fTemp27 = 3.0f * fRec27[0];
			float fTemp28 = fTemp27 + -1.0f;
			float fTemp29 = fTemp27 + -2.0f;
			float fTemp30 = (0.0f - fTemp28) * (0.0f - 0.5f * fTemp29) + 3.0f * fRec27[0] * (0.0f - fTemp29) + 1.5f * fRec27[0] * fTemp28;
			fRec29[0] = fSlow47 * fRec30[1] + fSlow46 * fRec29[1];
			fRec30[0] = fTemp5 + fSlow46 * fRec30[1] - fSlow47 * fRec29[1];
			int iTemp31 = (fRec29[1] <= 0.0f) & (fRec29[0] > 0.0f);
			fRec28[0] = fRec28[1] * float(1 - iTemp31) + 4.656613e-10f * fTemp7 * float(iTemp31);
			float fTemp32 = fRec28[0] * fTemp30;
			float fThen12 = ((fTemp32 < -1.0f) ? -1.0f : fTemp32);
			float fTemp33 = ((fTemp32 > 1.0f) ? 1.0f : fThen12);
			float fThen13 = float(input2[i0]);
			fRec35[0] = 0.0f - fSlow50 * (fSlow49 * fRec35[1] - (fRec28[0] + fRec28[1]));
			fRec34[0] = 0.0f - fSlow50 * (fSlow49 * fRec34[1] - (fRec35[0] + fRec35[1]));
			fRec33[0] = 0.0f - fSlow50 * (fSlow49 * fRec33[1] - (fRec34[0] + fRec34[1]));
			fRec32[0] = 0.0f - fSlow50 * (fSlow49 * fRec32[1] - (fRec33[0] + fRec33[1]));
			fRec31[0] = 0.0f - fSlow50 * (fSlow49 * fRec31[1] - (fRec32[0] + fRec32[1]));
			float fTemp34 = fRec31[0] * fTemp30;
			float fThen15 = ((fTemp34 < -1.0f) ? -1.0f : fTemp34);
			float fTemp35 = ((fTemp34 > 1.0f) ? 1.0f : fThen15);
			float fThen16 = ((iSlow42) ? fTemp33 : fThen13);
			float fTemp36 = fSlow52 + fRec37[1] + -1.0f;
			int iTemp37 = fTemp36 < 0.0f;
			float fTemp38 = fSlow52 + fRec37[1];
			fRec37[0] = ((iTemp37) ? fTemp38 : fTemp36);
			float fThen18 = fSlow52 + fRec37[1] + fSlow53 * fTemp36;
			float fRec38 = ((iTemp37) ? fTemp38 : fThen18);
			fRec36[0] = fConst27 * (2.0f * fRec38 + -1.0f) + fConst28 * fRec36[1];
			float fThen19 = ((iSlow41) ? fTemp35 : fThen16);
			fRec40[0] = fSlow56 + (fRec40[1] - std::floor(fSlow56 + fRec40[1]));
			float fTemp39 = mydsp_faustpower2_f(2.0f * fRec40[0] + -1.0f);
			fVec5[0] = fTemp39;
			float fTemp40 = fSlow57 * fTemp16 * (fTemp39 - fVec5[1]);
			fVec6[IOTA0 & 4095] = fTemp40;
			fRec39[0] = 0.999f * fRec39[1] + fTemp40 - (fSlow63 * fVec6[(IOTA0 - iSlow59) & 4095] + fSlow62 * fVec6[(IOTA0 - iSlow60) & 4095]);
			float fTemp41 = fSlow64 * fRec39[0];
			float fThen20 = ((iSlow40) ? fRec36[0] : fThen19);
			float fTemp42 = ftbl0mydspSIG0[int(65536.0f * fRec27[0])];
			float fThen21 = ((iSlow39) ? fTemp41 : fThen20);
			float fTemp43 = fTemp20 + -4.0f;
			float fTemp44 = fTemp25 * (0.0f - fTemp43) * (0.0f - 0.5f * fTemp21);
			fRec41[0] = fSlow73 + (fRec41[1] - std::floor(fSlow73 + fRec41[1]));
			float fTemp45 = 3.0f * fRec41[0];
			float fTemp46 = fTemp45 + -1.0f;
			float fTemp47 = fTemp45 + -2.0f;
			float fTemp48 = (0.0f - fTemp46) * (0.0f - 0.5f * fTemp47) + 3.0f * fRec41[0] * (0.0f - fTemp47) + 1.5f * fRec41[0] * fTemp46;
			fRec43[0] = fSlow76 * fRec44[1] + fSlow75 * fRec43[1];
			fRec44[0] = fTemp5 + fSlow75 * fRec44[1] - fSlow76 * fRec43[1];
			int iTemp49 = (fRec43[1] <= 0.0f) & (fRec43[0] > 0.0f);
			fRec42[0] = fRec42[1] * float(1 - iTemp49) + 4.656613e-10f * fTemp7 * float(iTemp49);
			float fTemp50 = fRec42[0] * fTemp48;
			float fThen23 = ((fTemp50 < -1.0f) ? -1.0f : fTemp50);
			float fTemp51 = ((fTemp50 > 1.0f) ? 1.0f : fThen23);
			float fThen24 = float(input1[i0]);
			fRec49[0] = 0.0f - fSlow79 * (fSlow78 * fRec49[1] - (fRec42[0] + fRec42[1]));
			fRec48[0] = 0.0f - fSlow79 * (fSlow78 * fRec48[1] - (fRec49[0] + fRec49[1]));
			fRec47[0] = 0.0f - fSlow79 * (fSlow78 * fRec47[1] - (fRec48[0] + fRec48[1]));
			fRec46[0] = 0.0f - fSlow79 * (fSlow78 * fRec46[1] - (fRec47[0] + fRec47[1]));
			fRec45[0] = 0.0f - fSlow79 * (fSlow78 * fRec45[1] - (fRec46[0] + fRec46[1]));
			float fTemp52 = fRec45[0] * fTemp48;
			float fThen26 = ((fTemp52 < -1.0f) ? -1.0f : fTemp52);
			float fTemp53 = ((fTemp52 > 1.0f) ? 1.0f : fThen26);
			float fThen27 = ((iSlow71) ? fTemp51 : fThen24);
			float fTemp54 = fSlow81 + fRec51[1] + -1.0f;
			int iTemp55 = fTemp54 < 0.0f;
			float fTemp56 = fSlow81 + fRec51[1];
			fRec51[0] = ((iTemp55) ? fTemp56 : fTemp54);
			float fThen29 = fSlow81 + fRec51[1] + fSlow82 * fTemp54;
			float fRec52 = ((iTemp55) ? fTemp56 : fThen29);
			fRec50[0] = fConst27 * (2.0f * fRec52 + -1.0f) + fConst28 * fRec50[1];
			float fThen30 = ((iSlow70) ? fTemp53 : fThen27);
			fRec54[0] = fSlow85 + (fRec54[1] - std::floor(fSlow85 + fRec54[1]));
			float fTemp57 = mydsp_faustpower2_f(2.0f * fRec54[0] + -1.0f);
			fVec7[0] = fTemp57;
			float fTemp58 = fSlow86 * fTemp16 * (fTemp57 - fVec7[1]);
			fVec8[IOTA0 & 4095] = fTemp58;
			fRec53[0] = 0.999f * fRec53[1] + fTemp58 - (fSlow92 * fVec8[(IOTA0 - iSlow88) & 4095] + fSlow91 * fVec8[(IOTA0 - iSlow89) & 4095]);
			float fTemp59 = fSlow93 * fRec53[0];
			float fThen31 = ((iSlow69) ? fRec50[0] : fThen30);
			float fTemp60 = ftbl0mydspSIG0[int(65536.0f * fRec41[0])];
			float fThen32 = ((iSlow68) ? fTemp59 : fThen31);
			float fTemp61 = fTemp24 * (0.0f - fTemp22) * (0.0f - 0.5f * fTemp43) * (0.0f - 0.33333334f * fTemp21);
			fRec55[0] = fSlow102 + (fRec55[1] - std::floor(fSlow102 + fRec55[1]));
			float fTemp62 = 3.0f * fRec55[0];
			float fTemp63 = fTemp62 + -1.0f;
			float fTemp64 = fTemp62 + -2.0f;
			float fTemp65 = (0.0f - fTemp63) * (0.0f - 0.5f * fTemp64) + 3.0f * fRec55[0] * (0.0f - fTemp64) + 1.5f * fRec55[0] * fTemp63;
			fRec57[0] = fSlow105 * fRec58[1] + fSlow104 * fRec57[1];
			fRec58[0] = fTemp5 + fSlow104 * fRec58[1] - fSlow105 * fRec57[1];
			int iTemp66 = (fRec57[1] <= 0.0f) & (fRec57[0] > 0.0f);
			fRec56[0] = fRec56[1] * float(1 - iTemp66) + 4.656613e-10f * fTemp7 * float(iTemp66);
			float fTemp67 = fRec56[0] * fTemp65;
			float fThen34 = ((fTemp67 < -1.0f) ? -1.0f : fTemp67);
			float fTemp68 = ((fTemp67 > 1.0f) ? 1.0f : fThen34);
			float fThen35 = float(input0[i0]);
			fRec63[0] = 0.0f - fSlow108 * (fSlow107 * fRec63[1] - (fRec56[0] + fRec56[1]));
			fRec62[0] = 0.0f - fSlow108 * (fSlow107 * fRec62[1] - (fRec63[0] + fRec63[1]));
			fRec61[0] = 0.0f - fSlow108 * (fSlow107 * fRec61[1] - (fRec62[0] + fRec62[1]));
			fRec60[0] = 0.0f - fSlow108 * (fSlow107 * fRec60[1] - (fRec61[0] + fRec61[1]));
			fRec59[0] = 0.0f - fSlow108 * (fSlow107 * fRec59[1] - (fRec60[0] + fRec60[1]));
			float fTemp69 = fRec59[0] * fTemp65;
			float fThen37 = ((fTemp69 < -1.0f) ? -1.0f : fTemp69);
			float fTemp70 = ((fTemp69 > 1.0f) ? 1.0f : fThen37);
			float fThen38 = ((iSlow100) ? fTemp68 : fThen35);
			float fTemp71 = fSlow110 + fRec65[1] + -1.0f;
			int iTemp72 = fTemp71 < 0.0f;
			float fTemp73 = fSlow110 + fRec65[1];
			fRec65[0] = ((iTemp72) ? fTemp73 : fTemp71);
			float fThen40 = fSlow110 + fRec65[1] + fSlow111 * fTemp71;
			float fRec66 = ((iTemp72) ? fTemp73 : fThen40);
			fRec64[0] = fConst27 * (2.0f * fRec66 + -1.0f) + fConst28 * fRec64[1];
			float fThen41 = ((iSlow99) ? fTemp70 : fThen38);
			fRec68[0] = fSlow114 + (fRec68[1] - std::floor(fSlow114 + fRec68[1]));
			float fTemp74 = mydsp_faustpower2_f(2.0f * fRec68[0] + -1.0f);
			fVec9[0] = fTemp74;
			float fTemp75 = fSlow115 * fTemp16 * (fTemp74 - fVec9[1]);
			fVec10[IOTA0 & 4095] = fTemp75;
			fRec67[0] = 0.999f * fRec67[1] + fTemp75 - (fSlow121 * fVec10[(IOTA0 - iSlow117) & 4095] + fSlow120 * fVec10[(IOTA0 - iSlow118) & 4095]);
			float fTemp76 = fSlow122 * fRec67[0];
			float fThen42 = ((iSlow98) ? fRec64[0] : fThen41);
			float fTemp77 = ftbl0mydspSIG0[int(65536.0f * fRec55[0])];
			float fThen43 = ((iSlow97) ? fTemp76 : fThen42);
			float fTemp78 = (0.0f - fTemp23) * (0.0f - 0.5f * fTemp22) * (0.0f - 0.33333334f * fTemp43) * (0.0f - 0.25f * fTemp21);
			float fThen44 = float(input7[i0]);
			float fThen45 = ((iSlow12) ? fTemp9 : fThen44);
			float fThen46 = ((iSlow11) ? fTemp11 : fThen45);
			float fThen47 = ((iSlow10) ? fRec20[0] : fThen46);
			float fThen48 = ((iSlow9) ? fTemp18 : fThen47);
			float fThen49 = float(input6[i0]);
			float fThen50 = ((iSlow42) ? fTemp33 : fThen49);
			float fThen51 = ((iSlow41) ? fTemp35 : fThen50);
			float fThen52 = ((iSlow40) ? fRec36[0] : fThen51);
			float fThen53 = ((iSlow39) ? fTemp41 : fThen52);
			float fThen54 = float(input5[i0]);
			float fThen55 = ((iSlow71) ? fTemp51 : fThen54);
			float fThen56 = ((iSlow70) ? fTemp53 : fThen55);
			float fThen57 = ((iSlow69) ? fRec50[0] : fThen56);
			float fThen58 = ((iSlow68) ? fTemp59 : fThen57);
			float fThen59 = float(input4[i0]);
			float fThen60 = ((iSlow100) ? fTemp68 : fThen59);
			float fThen61 = ((iSlow99) ? fTemp70 : fThen60);
			float fThen62 = ((iSlow98) ? fRec64[0] : fThen61);
			float fThen63 = ((iSlow97) ? fTemp76 : fThen62);
			float fThen64 = float(input11[i0]);
			float fThen65 = ((iSlow12) ? fTemp9 : fThen64);
			float fThen66 = ((iSlow11) ? fTemp11 : fThen65);
			float fThen67 = ((iSlow10) ? fRec20[0] : fThen66);
			float fThen68 = ((iSlow9) ? fTemp18 : fThen67);
			float fThen69 = float(input10[i0]);
			float fThen70 = ((iSlow42) ? fTemp33 : fThen69);
			float fThen71 = ((iSlow41) ? fTemp35 : fThen70);
			float fThen72 = ((iSlow40) ? fRec36[0] : fThen71);
			float fThen73 = ((iSlow39) ? fTemp41 : fThen72);
			float fThen74 = float(input9[i0]);
			float fThen75 = ((iSlow71) ? fTemp51 : fThen74);
			float fThen76 = ((iSlow70) ? fTemp53 : fThen75);
			float fThen77 = ((iSlow69) ? fRec50[0] : fThen76);
			float fThen78 = ((iSlow68) ? fTemp59 : fThen77);
			float fThen79 = float(input8[i0]);
			float fThen80 = ((iSlow100) ? fTemp68 : fThen79);
			float fThen81 = ((iSlow99) ? fTemp70 : fThen80);
			float fThen82 = ((iSlow98) ? fRec64[0] : fThen81);
			float fThen83 = ((iSlow97) ? fTemp76 : fThen82);
			float fThen84 = fRec26[0] * (fSlow123 * fTemp78 * ((iSlow96) ? fTemp77 : fThen83) + fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen78) + fSlow65 * fTemp44 * ((iSlow38) ? fTemp42 : fThen73) + fSlow36 * fTemp26 * ((iSlow8) ? fTemp19 : fThen68));
			float fThen85 = (((fRec26[0] * (fSlow123 * fTemp78 * ((iSlow96) ? fTemp77 : fThen63) + fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen58) + fSlow65 * fTemp44 * ((iSlow38) ? fTemp42 : fThen53) + fSlow36 * fTemp26 * ((iSlow8) ? fTemp19 : fThen48))) < -1.0f) ? -1.0f : fThen84);
			fRec9[0] = (((fRec26[0] * (fSlow123 * fTemp78 * ((iSlow96) ? fTemp77 : fThen43) + fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen32) + fSlow65 * fTemp44 * ((iSlow38) ? fTemp42 : fThen21) + fSlow36 * fTemp26 * ((iSlow8) ? fTemp19 : fThen10))) > 1.0f) ? 1.0f : fThen85) - fConst23 * (fConst22 * fRec9[2] + fConst5 * fRec9[1]);
			fRec8[0] = fConst23 * (fConst4 * fRec9[0] + fConst32 * fRec9[1] + fConst4 * fRec9[2]) - fConst21 * (fConst20 * fRec8[2] + fConst5 * fRec8[1]);
			fRec7[0] = fConst21 * (fConst4 * fRec8[0] + fConst32 * fRec8[1] + fConst4 * fRec8[2]) - fConst19 * (fConst18 * fRec7[2] + fConst5 * fRec7[1]);
			fRec6[0] = fConst19 * (fConst4 * fRec7[0] + fConst32 * fRec7[1] + fConst4 * fRec7[2]) - fConst17 * (fConst16 * fRec6[2] + fConst5 * fRec6[1]);
			fRec5[0] = fConst17 * (fConst4 * fRec6[0] + fConst32 * fRec6[1] + fConst4 * fRec6[2]) - fConst15 * (fConst14 * fRec5[2] + fConst5 * fRec5[1]);
			fRec4[0] = fConst15 * (fConst4 * fRec5[0] + fConst32 * fRec5[1] + fConst4 * fRec5[2]) - fConst13 * (fConst12 * fRec4[2] + fConst5 * fRec4[1]);
			fRec3[0] = fConst13 * (fConst4 * fRec4[0] + fConst32 * fRec4[1] + fConst4 * fRec4[2]) - fConst11 * (fConst10 * fRec3[2] + fConst5 * fRec3[1]);
			fRec2[0] = fConst11 * (fConst4 * fRec3[0] + fConst32 * fRec3[1] + fConst4 * fRec3[2]) - fConst9 * (fConst7 * fRec2[2] + fConst5 * fRec2[1]);
			output0[i0] = FAUSTFLOAT(fSlow124 * (fConst4 * fRec2[0] + fConst32 * fRec2[1] + fConst4 * fRec2[2]) * fTemp0);
			float fThen86 = float(input15[i0]);
			float fThen87 = ((iSlow12) ? fTemp9 : fThen86);
			float fThen88 = ((iSlow11) ? fTemp11 : fThen87);
			float fThen89 = ((iSlow10) ? fRec20[0] : fThen88);
			float fThen90 = ((iSlow9) ? fTemp18 : fThen89);
			float fThen91 = float(input14[i0]);
			float fThen92 = ((iSlow42) ? fTemp33 : fThen91);
			float fThen93 = ((iSlow41) ? fTemp35 : fThen92);
			float fThen94 = ((iSlow40) ? fRec36[0] : fThen93);
			float fThen95 = ((iSlow39) ? fTemp41 : fThen94);
			float fThen96 = float(input13[i0]);
			float fThen97 = ((iSlow71) ? fTemp51 : fThen96);
			float fThen98 = ((iSlow70) ? fTemp53 : fThen97);
			float fThen99 = ((iSlow69) ? fRec50[0] : fThen98);
			float fThen100 = ((iSlow68) ? fTemp59 : fThen99);
			float fThen101 = float(input12[i0]);
			float fThen102 = ((iSlow100) ? fTemp68 : fThen101);
			float fThen103 = ((iSlow99) ? fTemp70 : fThen102);
			float fThen104 = ((iSlow98) ? fRec64[0] : fThen103);
			float fThen105 = ((iSlow97) ? fTemp76 : fThen104);
			float fThen106 = float(input19[i0]);
			float fThen107 = ((iSlow12) ? fTemp9 : fThen106);
			float fThen108 = ((iSlow11) ? fTemp11 : fThen107);
			float fThen109 = ((iSlow10) ? fRec20[0] : fThen108);
			float fThen110 = ((iSlow9) ? fTemp18 : fThen109);
			float fThen111 = float(input18[i0]);
			float fThen112 = ((iSlow42) ? fTemp33 : fThen111);
			float fThen113 = ((iSlow41) ? fTemp35 : fThen112);
			float fThen114 = ((iSlow40) ? fRec36[0] : fThen113);
			float fThen115 = ((iSlow39) ? fTemp41 : fThen114);
			float fThen116 = float(input17[i0]);
			float fThen117 = ((iSlow71) ? fTemp51 : fThen116);
			float fThen118 = ((iSlow70) ? fTemp53 : fThen117);
			float fThen119 = ((iSlow69) ? fRec50[0] : fThen118);
			float fThen120 = ((iSlow68) ? fTemp59 : fThen119);
			float fThen121 = float(input16[i0]);
			float fThen122 = ((iSlow100) ? fTemp68 : fThen121);
			float fThen123 = ((iSlow99) ? fTemp70 : fThen122);
			float fThen124 = ((iSlow98) ? fRec64[0] : fThen123);
			float fThen125 = ((iSlow97) ? fTemp76 : fThen124);
			float fThen126 = float(input23[i0]);
			float fThen127 = ((iSlow12) ? fTemp9 : fThen126);
			float fThen128 = ((iSlow11) ? fTemp11 : fThen127);
			float fThen129 = ((iSlow10) ? fRec20[0] : fThen128);
			float fThen130 = ((iSlow9) ? fTemp18 : fThen129);
			float fThen131 = float(input22[i0]);
			float fThen132 = ((iSlow42) ? fTemp33 : fThen131);
			float fThen133 = ((iSlow41) ? fTemp35 : fThen132);
			float fThen134 = ((iSlow40) ? fRec36[0] : fThen133);
			float fThen135 = ((iSlow39) ? fTemp41 : fThen134);
			float fThen136 = float(input21[i0]);
			float fThen137 = ((iSlow71) ? fTemp51 : fThen136);
			float fThen138 = ((iSlow70) ? fTemp53 : fThen137);
			float fThen139 = ((iSlow69) ? fRec50[0] : fThen138);
			float fThen140 = ((iSlow68) ? fTemp59 : fThen139);
			float fThen141 = float(input20[i0]);
			float fThen142 = ((iSlow100) ? fTemp68 : fThen141);
			float fThen143 = ((iSlow99) ? fTemp70 : fThen142);
			float fThen144 = ((iSlow98) ? fRec64[0] : fThen143);
			float fThen145 = ((iSlow97) ? fTemp76 : fThen144);
			float fThen146 = fRec26[0] * (fSlow123 * fTemp78 * ((iSlow96) ? fTemp77 : fThen145) + fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen140) + fSlow65 * fTemp44 * ((iSlow38) ? fTemp42 : fThen135) + fSlow36 * fTemp26 * ((iSlow8) ? fTemp19 : fThen130));
			float fThen147 = (((fRec26[0] * (fSlow123 * fTemp78 * ((iSlow96) ? fTemp77 : fThen125) + fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen120) + fSlow65 * fTemp44 * ((iSlow38) ? fTemp42 : fThen115) + fSlow36 * fTemp26 * ((iSlow8) ? fTemp19 : fThen110))) < -1.0f) ? -1.0f : fThen146);
			fRec76[0] = (((fRec26[0] * (fSlow123 * fTemp78 * ((iSlow96) ? fTemp77 : fThen105) + fSlow94 * fTemp61 * ((iSlow67) ? fTemp60 : fThen100) + fSlow65 * fTemp44 * ((iSlow38) ? fTemp42 : fThen95) + fSlow36 * fTemp26 * ((iSlow8) ? fTemp19 : fThen90))) > 1.0f) ? 1.0f : fThen147) - fConst23 * (fConst22 * fRec76[2] + fConst5 * fRec76[1]);
			fRec75[0] = fConst23 * (fConst4 * fRec76[0] + fConst32 * fRec76[1] + fConst4 * fRec76[2]) - fConst21 * (fConst20 * fRec75[2] + fConst5 * fRec75[1]);
			fRec74[0] = fConst21 * (fConst4 * fRec75[0] + fConst32 * fRec75[1] + fConst4 * fRec75[2]) - fConst19 * (fConst18 * fRec74[2] + fConst5 * fRec74[1]);
			fRec73[0] = fConst19 * (fConst4 * fRec74[0] + fConst32 * fRec74[1] + fConst4 * fRec74[2]) - fConst17 * (fConst16 * fRec73[2] + fConst5 * fRec73[1]);
			fRec72[0] = fConst17 * (fConst4 * fRec73[0] + fConst32 * fRec73[1] + fConst4 * fRec73[2]) - fConst15 * (fConst14 * fRec72[2] + fConst5 * fRec72[1]);
			fRec71[0] = fConst15 * (fConst4 * fRec72[0] + fConst32 * fRec72[1] + fConst4 * fRec72[2]) - fConst13 * (fConst12 * fRec71[2] + fConst5 * fRec71[1]);
			fRec70[0] = fConst13 * (fConst4 * fRec71[0] + fConst32 * fRec71[1] + fConst4 * fRec71[2]) - fConst11 * (fConst10 * fRec70[2] + fConst5 * fRec70[1]);
			fRec69[0] = fConst11 * (fConst4 * fRec70[0] + fConst32 * fRec70[1] + fConst4 * fRec70[2]) - fConst9 * (fConst7 * fRec69[2] + fConst5 * fRec69[1]);
			output1[i0] = FAUSTFLOAT(fSlow124 * fTemp0 * (fConst4 * fRec69[0] + fConst32 * fRec69[1] + fConst4 * fRec69[2]));
			iVec0[1] = iVec0[0];
			fVec1[1] = fVec1[0];
			iRec0[1] = iRec0[0];
			fRec1[1] = fRec1[0];
	...
	#define FAUST_FILE_NAME "stray_1_2.dsp"
	...
	#define FAUST_INPUTS 24
	#define FAUST_OUTPUTS 2
	#define FAUST_ACTIVES 19
	#define FAUST_PASSIVES 0

	FAUST_ADDVERTICALSLIDER("Wave Point Control/[0]Point Oscillation Frequency/P0 Freq", fVslider3, 0.001f, 0.001f, 2e+01f, 0.001f);
	FAUST_ADDVERTICALSLIDER("Wave Point Control/[0]Point Oscillation Frequency/P1 Freq", fVslider2, 0.001f, 0.001f, 2e+01f, 0.001f);
	FAUST_ADDVERTICALSLIDER("Wave Point Control/[0]Point Oscillation Frequency/P2 Freq", fVslider1, 0.001f, 0.001f, 2e+01f, 0.001f);
	FAUST_ADDVERTICALSLIDER("Wave Point Control/[0]Point Oscillation Frequency/P3 Freq", fVslider0, 0.001f, 0.001f, 2e+01f, 0.001f);
	FAUST_ADDCHECKBOX("Wave Point Control/[1]Point LFO/[2]On | Off/P0 Toggle", fCheckbox3);
	FAUST_ADDCHECKBOX("Wave Point Control/[1]Point LFO/[2]On | Off/P1 Toggle", fCheckbox2);
	FAUST_ADDCHECKBOX("Wave Point Control/[1]Point LFO/[2]On | Off/P2 Toggle", fCheckbox1);
	FAUST_ADDCHECKBOX("Wave Point Control/[1]Point LFO/[2]On | Off/P3 Toggle", fCheckbox0);
	FAUST_ADDNUMENTRY("Wave Point Control/[1]Point LFO/[3]LFO Shape: 0 = sin, 1 = tri, 2 = saw, 3 = smooth rand, 4 = coarse rand/P0 Shape", fEntry3, 0.0f, 0.0f, 4.0f, 1.0f);
	FAUST_ADDNUMENTRY("Wave Point Control/[1]Point LFO/[3]LFO Shape: 0 = sin, 1 = tri, 2 = saw, 3 = smooth rand, 4 = coarse rand/P1 Shape", fEntry2, 0.0f, 0.0f, 4.0f, 1.0f);
	FAUST_ADDNUMENTRY("Wave Point Control/[1]Point LFO/[3]LFO Shape: 0 = sin, 1 = tri, 2 = saw, 3 = smooth rand, 4 = coarse rand/P2 Shape", fEntry1, 0.0f, 0.0f, 4.0f, 1.0f);
	FAUST_ADDNUMENTRY("Wave Point Control/[1]Point LFO/[3]LFO Shape: 0 = sin, 1 = tri, 2 = saw, 3 = smooth rand, 4 = coarse rand/P3 Shape", fEntry0, 0.0f, 0.0f, 4.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("[0]Envelope/Attack", fHslider1, 5e+01f, 1.0f, 1e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("[0]Envelope/Decay", fHslider2, 5e+01f, 1.0f, 1e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("[0]Envelope/Sustain", fHslider3, 0.8f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("[0]Envelope/Release", fHslider0, 5e+01f, 1.0f, 1e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("[0]Envelope/gain", fHslider5, 1.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDBUTTON("[0]Envelope/gate", fButton0);
	FAUST_ADDHORIZONTALSLIDER("freq", fHslider4, 3e+02f, 2e+01f, 3e+03f, 0.1f);

	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, P0_Freq, "Wave Point Control/[0]Point Oscillation Frequency/P0 Freq", fVslider3, 0.001f, 0.001f, 2e+01f, 0.001f) \
		p(VERTICALSLIDER, P1_Freq, "Wave Point Control/[0]Point Oscillation Frequency/P1 Freq", fVslider2, 0.001f, 0.001f, 2e+01f, 0.001f) \
		p(VERTICALSLIDER, P2_Freq, "Wave Point Control/[0]Point Oscillation Frequency/P2 Freq", fVslider1, 0.001f, 0.001f, 2e+01f, 0.001f) \
		p(VERTICALSLIDER, P3_Freq, "Wave Point Control/[0]Point Oscillation Frequency/P3 Freq", fVslider0, 0.001f, 0.001f, 2e+01f, 0.001f) \
		p(CHECKBOX, P0_Toggle, "Wave Point Control/[1]Point LFO/[2]On | Off/P0 Toggle", fCheckbox3, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, P1_Toggle, "Wave Point Control/[1]Point LFO/[2]On | Off/P1 Toggle", fCheckbox2, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, P2_Toggle, "Wave Point Control/[1]Point LFO/[2]On | Off/P2 Toggle", fCheckbox1, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(CHECKBOX, P3_Toggle, "Wave Point Control/[1]Point LFO/[2]On | Off/P3 Toggle", fCheckbox0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(NUMENTRY, P0_Shape, "Wave Point Control/[1]Point LFO/[3]LFO Shape: 0 = sin, 1 = tri, 2 = saw, 3 = smooth rand, 4 = coarse rand/P0 Shape", fEntry3, 0.0f, 0.0f, 4.0f, 1.0f) \
		p(NUMENTRY, P1_Shape, "Wave Point Control/[1]Point LFO/[3]LFO Shape: 0 = sin, 1 = tri, 2 = saw, 3 = smooth rand, 4 = coarse rand/P1 Shape", fEntry2, 0.0f, 0.0f, 4.0f, 1.0f) \
		p(NUMENTRY, P2_Shape, "Wave Point Control/[1]Point LFO/[3]LFO Shape: 0 = sin, 1 = tri, 2 = saw, 3 = smooth rand, 4 = coarse rand/P2 Shape", fEntry1, 0.0f, 0.0f, 4.0f, 1.0f) \
		p(NUMENTRY, P3_Shape, "Wave Point Control/[1]Point LFO/[3]LFO Shape: 0 = sin, 1 = tri, 2 = saw, 3 = smooth rand, 4 = coarse rand/P3 Shape", fEntry0, 0.0f, 0.0f, 4.0f, 1.0f) \
		p(HORIZONTALSLIDER, Attack, "[0]Envelope/Attack", fHslider1, 5e+01f, 1.0f, 1e+03f, 1.0f) \
		p(HORIZONTALSLIDER, Decay, "[0]Envelope/Decay", fHslider2, 5e+01f, 1.0f, 1e+03f, 1.0f) \
		p(HORIZONTALSLIDER, Sustain, "[0]Envelope/Sustain", fHslider3, 0.8f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, Release, "[0]Envelope/Release", fHslider0, 5e+01f, 1.0f, 1e+03f, 1.0f) \
		p(HORIZONTALSLIDER, gain, "[0]Envelope/gain", fHslider5, 1.0f, 0.0f, 1.0f, 0.01f) \
		p(BUTTON, gate, "[0]Envelope/gate", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, freq, "freq", fHslider4, 3e+02f, 2e+01f, 3e+03f, 0.1f) \
