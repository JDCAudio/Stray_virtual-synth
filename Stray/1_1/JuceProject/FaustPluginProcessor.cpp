...
class mydsp : public base_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "stray_1_1.dsp");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("stray_1_1");
		...
		ui_interface->addHorizontalSlider("Sustain", &fHslider3, FAUSTFLOAT(0.8f), FAUSTFLOAT(0.01f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
	...
	#define FAUST_FILE_NAME "stray_1_1.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("[0]Envelope/Sustain", fHslider3, 0.8f, 0.01f, 1.0f, 1.0f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(HORIZONTALSLIDER, Sustain, "[0]Envelope/Sustain", fHslider3, 0.8f, 0.01f, 1.0f, 1.0f) \
